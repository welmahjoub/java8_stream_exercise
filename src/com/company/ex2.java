...
public class ex2 {
    ...
    public static void main(String[] args) {
        ...
        List<Voiture> liste2 = Arrays.asList(new Voiture("citroen"),
                new Voiture("renault"),
                new Voiture("audi"),
                new Voiture("citroen"));


        Map<String, List<Voiture>> map = liste2.stream().collect(Collectors.groupingBy(Voiture::getMarque));
...
// mapping du stream de voiture en stream de String
        Set<String> marques = liste2.stream()
